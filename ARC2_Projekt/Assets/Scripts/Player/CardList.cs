...
public class CardList : MonoBehaviour
{
    ...
    private void Awake() 
    {
        ...
        cardsList.Add(new CardList.Cards(1, "Postac w ogromnym szale zaczyna ryczec na przeciwnika.", "Bestialski ryk", "Atak", "Atak", 
                                            2, 1, 70, true, true));
        cardsList.Add(new CardList.Cards(2, "Postac wymierza sprawiedliwosc przeciwnikowi przez uderzenie otwarta dlonia.", "Spadajacy lisc", "Atak", "Atak", 
                                            4, 2, 120, true, true));
        cardsList.Add(new CardList.Cards(3, "Postac obzera sie kanapkami zwiekszajac swoja mase tluszczowa.", "Grubo skorny", "Obrona", "Obrona", 
                                            3, 1, 80, true, true));
        cardsList.Add(new CardList.Cards(4, "Postac wyciaga krolika z kapelusza, ktory zaslania nasza postac przed obrazeniami.", "Znikajacy krolik", "Obrona", "Obrona", 
                                            1, 0, 50, false, false));
        ...
        cardsList.Add(new CardList.Cards(7, "Postac pije ostry sos po czym zaczyna ziac ogniem.", "Palace gardlo", "Atak", "Atak", 
                                            6, 3, 200, false, false));
        cardsList.Add(new CardList.Cards(8, "Postac dziabie palcem przeciwnika w oko (o ile je ma).", "Paluszek", "Atak", "Atak", 
                                            4, 3, 80, false, false));
        ...
        cardsList.Add(new CardList.Cards(11, "Postac powtarza co chwile slowo \"Azaliz\" rzucajac przy tym czar niszczacy psychike przeciwnika.", "Azaliz", "Atak", "Atak", 
                                            8, 4, 250, false, false));
        cardsList.Add(new CardList.Cards(12, "Postac wypluwa z ust ogromna ilosc wody, ktora zalewa przeciwnika.", "Lanie wody", "Atak", "Atak", 
                                            5, 3, 150, false, false));
        cardsList.Add(new CardList.Cards(13, "Postac depcze swoje okulary i zaklada nowe.", "Nowe okulary", "Obrona", "Obrona", 
                                            13, 5, 250, false, false));
        cardsList.Add(new CardList.Cards(14, "Postac oslepia wroga swym spojrzeniem zabierajac mu jeden ruch w jego turze.", "Blyszczace oko", "Specjalna", "Ogluszenie", 
                                            0, 4, 70, false, false));
        cardsList.Add(new CardList.Cards(15, "Postac je drugie sniadanie i sie leczy.", "A co ze sniadaniem?", "Specjalna", "Leczenie", 
                                            10, 0, 120, false, false));
        cardsList.Add(new CardList.Cards(16, "Postac oblewa przeciwnika zepsutym budyniem i zmniejsza mu atak procentowo.", "Poranny deser", "Specjalna", "Oslabienie", 
                                            25, 5, 140, false, false));
        cardsList.Add(new CardList.Cards(17, "Postac otrzymuje darmowy ruch w tej turze.", "Robic robic", "Specjalna", "Pospiech", 
                                            0, 3, 40, false, false));
