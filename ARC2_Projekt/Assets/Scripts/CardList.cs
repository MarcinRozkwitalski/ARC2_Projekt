...
public class CardList : MonoBehaviour
{
    ...
    private void Awake() 
    {
        ...
        cardsList.Add(new CardList.Cards(7, "Postac pije ostry sos po czym zaczyna ziac ogniem.", "Palace gardlo", "Atak", "Atak", 6, 3, 200, false, false));
        cardsList.Add(new CardList.Cards(8, "Postac dziabie palcem przeciwnika w oko (o ile je ma).", "Paluszek", "Atak", "Atak", 4, 3, 80, false, false));
        cardsList.Add(new CardList.Cards(9, "Postac ubiera zolta bluze, ktora dodaje klasy jak i punkty obrony.", "Slynna bluza", "Obrona", "Obrona", 10, 4, 180, false, false));
        cardsList.Add(new CardList.Cards(10, "Postac przyczepia do siebie banany za pomoca taśmy klejacej.", "Banan na droge", "Obrona", "Obrona", 6, 2, 140, false, false));
        cardsList.Add(new CardList.Cards(11, "Postac powtarza co chwile slowo \"Azaliz\" rzucajac przy tym czar niszczacy psychike przeciwnika.", "Azaliz", "Atak", "Atak", 8, 4, 250, false, false));
        cardsList.Add(new CardList.Cards(12, "Postac wypluwa z ust ogromna ilosc wody, ktora zalewa przeciwnika.", "Lanie wody", "Atak", "Atak", 5, 3, 150, false, false));
        ...
        cardsList.Add(new CardList.Cards(20, "Losowy efekt, gdzie atakujemy lub dodajemy obrone, badz leczymy sie za darmo.", "Czy to wybawienie?", "Specjalna", "Tecza", 20, 5, 400, false, false));
        cardsList.Add(new CardList.Cards(21, "Podwojenie obecnej ilosci obrony (nie zuzywa ruchu).", "Zelazne boki", "Specjalna", "Wzmocnienie", 2, 4, 200, false, false));
    }
}